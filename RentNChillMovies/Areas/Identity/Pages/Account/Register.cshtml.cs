...
namespace RentNChillMovies.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (_userManager.FindByNameAsync(user.UserName).Equals(user.UserName))
                {
                    Console.WriteLine("User already exists nom");
                }
